...
census_df <- read_csv("data/e&w_census_data.csv") 
segmentation_df <- read_csv("data/england_and_wales_oa_segmentation.csv")
...
write_csv(pca_correlation, ("data/demographic_pca_correlations_e&w.csv"))
write_csv(merged_df_england_wales, ("data/merged_df_england_wales.csv"))
...
plot<- ggplot(pca_correlation_long, aes(x = dimension, y = reorder(variable, correlation), fill = correlation)) +
  geom_tile() +
